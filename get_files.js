...
function extractKeywords() {
  ...
  if ( url != "" ) {
    ...
    var request = "http://cs.uef.fi/~himat/Drank/get_dom.php?url=" + url;    
	console.log(request);	
    g_filesRead = 0;
...
function readText() {
    var request ="http://cs.uef.fi/~himat/Drank/io/Text.txt?rand=" + Math.random(); 
...
//////////////////////////////////////
function readScore() {
    var request = "http://cs.uef.fi/~himat/Drank/io/Score.txt?rand=" + Math.random();
...
function readKeywords() {
    var request = "http://cs.uef.fi/~himat/Drank/io/Keywords.txt?rand=" + Math.random();
